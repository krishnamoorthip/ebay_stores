...
function showStoresPage() {
    ...
    result.done(function (rs) {
        ...
        if (rs.result.error === false) {
            ...
            table = table + '<thead><tr><th>SL. No.</th><th>Store ID</th><th>Link</th><th>Email</th><th>Phone</th><th>Comment</th><th>Status</th><th>Lead By</th><th>Created On</th><th>Updated On</th><th></th></tr></thead><tbody>';
